...
namespace PizzariaMvc.Controllers
{
    public class PizzasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Sabor,TamanhoPizza")] Pizza pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Sabor,TamanhoPizza")] Pizza pizza)
        {
            if (id != pizza.Id)
            {
                return NotFound();
